...
function Posts({ postData }: Props) {
    ...
    return (
        <Link href={`post/${postData.slug.current}/`} className='flex w-full gap-4 py-6'>
            <div className='w-full space-y-1'>
                ...
                <div className='flex flex-col justify-between h-full'>
                    <div>
                        ...
                        <p className={`${postData.author.image ? 'hidden' : ''} text-gray-600 sm:block`}>{postData.description}</p>
                    </div>
